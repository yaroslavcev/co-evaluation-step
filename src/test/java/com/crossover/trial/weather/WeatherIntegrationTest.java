...
/**
 * Integration test that starts WeatherService, load airports with AirportLoader
 * and uses WeatherClient to test correct functioning of the REST Api.
 * 
 * @author Ilya
 *
 */
public class WeatherIntegrationTest {
    ...
    private void checkStatisitic(Map<String, Object> statisticMap) {
        ...
        Assert.assertEquals(Arrays.asList(0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 1d),
                statisticMap.get("radius_freq"));
